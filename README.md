...
This project is to showcase css styles. Made with react it's made for simple way to copy simple css styles.
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/css-generator.git
   ```
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/css-generator.git)
